   ...
   */
   ...
   if (Use_Daily_Target) {
      ...
      if ((G_d_2 >= Daily_Target)) {
         ES_Log_Event_Double("DAILY_TARGET_HIT", "closed_pl_today", G_d_2);
            ...
            do {
               ...
               if (OrderSymbol() == _Symbol) {
                  if (OrderSymbol() == _Symbol && OrderMagicNumber() == I_i_71) {
                     if (OrderType() == OP_BUY) {
                        I_b_7 = ES_Log_OrderClose(OrderTicket(), OrderLots(), Bid, (int)I_d_34, 16711680);
                     }
                     if (OrderType() == OP_SELL) {
                        I_b_7 = ES_Log_OrderClose(OrderTicket(), OrderLots(), Ask, (int)I_d_34, 255);
                     }
                  }
                  Sleep(1000);
               }
   ...
   if (Hidden_TP) {
      ...
      if ((Hiden_TP <= G_d_3)) {
         ES_Log_Event_Double("HIDDEN_TP_HIT", "floating_pl", G_d_3);
         Print("\nMagic Take Profit");
   ...
   I_d_47 = Step;
   I_i_71 = I_i_0;
   ES_Log_SetContext(_Symbol, Period(), I_i_71);
   L_s_1 = "false";
   L_s_2 = "false";
   G_i_75 = I_b_11;
   if ((G_i_75 == 0)
   ...
   if (UseEquityStop && (G_d_4 < 0)) {
      ...
      if ((G_d_55 > (G_d_56 * I_d_57))) {
         ES_Log_Event_EquityStop(G_d_55, G_d_56, I_d_57, G_d_4);
         G_i_85 = OrdersTotal() - 1;
         G_i_18 = G_i_85;
         if (G_i_85 >= 0) {
            do {
   ...
   ES_Log_Event_TPAssign(I_d_48, I_d_80);
   G_i_100 = I_b_17;
   ...
   do {
      ...
      if (OrderSymbol() == _Symbol && OrderMagicNumber() == I_i_71) {
         if (OrderSymbol() == _Symbol && OrderMagicNumber() == I_i_71) {
            I_b_7 = ES_Log_OrderModify(OrderTicket(), I_d_48, OrderStopLoss(), I_d_80, 0, 65535);
         }
         I_b_16 = false;
      }
      I_i_84 = I_i_84 - 1;
      ...
      if (OrderSelect(L_i_12, 0, 0) && OrderSymbol() == _Symbol && OrderMagicNumber() == I_i_71) {
         if (OrderType() == OP_BUY && FuncArg_Boolean_00000000) {
            ...
            if (!IsTradeContextBusy()) {
               if (!ES_Log_OrderClose(OrderTicket(), OrderLots(), NormalizeDouble(Bid, _Digits), 5, 4294967295)) {
         ...
         if (OrderType() == OP_SELL && FuncArg_Boolean_00000001) {
            RefreshRates();
            if (!IsTradeContextBusy()) {
               if (!ES_Log_OrderClose(OrderTicket(), OrderLots(), NormalizeDouble(Ask, _Digits), 5, 4294967295)) {
...
int f0_15(int Fa_i_00, double Fa_d_01, double Fa_d_02, int Fa_i_03, double Fa_d_04, double Fa_d_05, int Fa_i_06, string Fa_s_07, int Fa_i_08, int Fa_i_09, int Fa_i_0A) {
   ...
   if (I_i_1 == 2) {
      ...
      do {
         ...
         L_i_11 = ES_Log_OrderSend(_Symbol, 2, Fa_d_01, Fa_d_02, Fa_i_03, G_d_2, G_d_3, Fa_s_07, Fa_i_08, Fa_i_09, G_i_31);
         if (L_i_11 > 0) {
            I_i_76 = I_i_76 + 1;
         }
   ...
   if (I_i_1 == 4) {
      ...
      do {
         ...
         L_i_11 = ES_Log_OrderSend(_Symbol, 4, Fa_d_01, Fa_d_02, Fa_i_03, G_d_109, G_d_111, Fa_s_07, Fa_i_08, Fa_i_09, G_i_33);
         if (L_i_11 > 0) {
            I_i_76 = I_i_76 + 1;
         }
         G_i_35 = GetLastError();
   ...
   if (I_i_1 == 0) {
      ...
      do {
         ...
         L_i_11 = ES_Log_OrderSend(_Symbol, 0, Fa_d_01, Ask, Fa_i_03, G_d_113, G_d_115, Fa_s_07, Fa_i_08, Fa_i_09, G_i_36);
         if (L_i_11 > 0) {
            I_i_76 = I_i_76 + 1;
         }
   ...
   if (I_i_1 == 3) {
      ...
      do {
         ...
         L_i_11 = ES_Log_OrderSend(_Symbol, 3, Fa_d_01, Fa_d_02, Fa_i_03, G_d_116, G_d_118, Fa_s_07, Fa_i_08, Fa_i_09, G_i_38);
         if (L_i_11 > 0) {
            I_i_76 = I_i_76 + 1;
         }
         G_i_40 = GetLastError();
   ...
   if (I_i_1 == 5) {
      ...
      do {
         ...
         L_i_11 = ES_Log_OrderSend(_Symbol, 5, Fa_d_01, Fa_d_02, Fa_i_03, G_d_119, G_d_121, Fa_s_07, Fa_i_08, Fa_i_09, G_i_41);
         if (L_i_11 > 0) {
            I_i_76 = I_i_76 + 1;
         }
         G_i_43 = GetLastError();
   ...
   if (I_i_1 == 1) {
      ...
      do {
         ...
         L_i_11 = ES_Log_OrderSend(_Symbol, 1, Fa_d_01, Bid, Fa_i_03, G_d_7, G_d_124, Fa_s_07, Fa_i_08, Fa_i_09, G_i_44);
         if (L_i_11 > 0) {
            I_i_76 = I_i_76 + 1;
         }
         G_i_46 = GetLastError();
         ...
         if (OrderSymbol() == _Symbol || OrderMagicNumber() == I_i_71) {
            if (OrderType() == OP_BUY) {
               ...
               if (returned_double == 0 || (returned_double != 0 && L_d_14 > returned_double)) {
                  I_b_7 = ES_Log_OrderModify(OrderTicket(), Fa_d_02, L_d_14, OrderTakeProfit(), 0, 16776960);
               }
            }
            if (OrderType() == OP_SELL) {
               G_d_106 = (Fa_d_02 - Ask);
               ...
               if (returned_double == 0 || (returned_double != 0 && L_d_14 < returned_double)) {
                  I_b_7 = ES_Log_OrderModify(OrderTicket(), Fa_d_02, L_d_14, OrderTakeProfit(), 0, 255);
               }
            }
         }
         Sleep(1000);
